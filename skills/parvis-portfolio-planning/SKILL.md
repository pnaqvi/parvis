...
description: >
  ...
  (repeat slippage, watermelon statuses, dependency red flags, decision latency,
  silence) and drives recovery with priced get-well options. Fires on "run my
  ...
  quarter", "should we kill W", "portfolio heatmap", "rebalance the portfolio",
  "stress-test the plan", "are we overcommitted vs capacity". Not for technical content
  (parvis-infra-advisor) or people performance (parvis-people-leader). Owns the
  analysis, never the sent artifacts. "Build the MBR", "draft the QBR" and "draft the
  September plan" go to parvis-reviews.
---
